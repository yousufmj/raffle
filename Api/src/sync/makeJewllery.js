...
const myriad = new Sequelize('myriad_mj', 'mj_myriad', '597KPWba', {
  host: 'www.makeselljewellery.com',
  dialect: 'mysql',
  ...
  try {
    ...
    for (; i < iMax; i++) {
      ...
      element.other = {
        ...
        MC_thirdphone: element.MC_thirdphone,
        MC_thirdemail: element.MC_thirdemail,
        MC_thirdmm: element.MC_thirdmms
      };
