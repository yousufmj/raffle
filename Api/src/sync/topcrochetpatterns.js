...
const myriad = new Sequelize(
  'tpc_givea7d5',
  'tpc_giveadm5',
  '#9J(Lp&0sq&lR97S',
  {
    host: 'www.topcrochetpatterns.com',
    dialect: 'mysql',
...
const betweenDates = `date between '${startDate}' and '${endDate}'`;
